...
public class iOS_SimulateCapture {
    ...
    public void setUp() throws IOException {
        ...
        dc.setCapability("testName", "iOS_Native_SimulateCapture");
    ...
    public void testing_01() throws InterruptedException {
        ...
        waitForElement(By.xpath("//*[@id='Scan Check' and @class='UIAStaticText']"));
        driver.findElement(By.xpath("//*[@id='Scan Check' and @class='UIAStaticText']")).click();
